    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
          <span className="text-sm text-gray-600 dark:text-gray-400" style={{ padding: "6px 12px", borderRadius: 8, background: "rgba(0,0,0,0.03)" }} className="dark:bg-[rgba(255,255,255,0.05)]">
